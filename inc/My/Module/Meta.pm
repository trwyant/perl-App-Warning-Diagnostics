...
sub dist_name {
    return 'App-Warning-Diagnostics';
}
...
sub meta_merge {
	...
	resources	=> {
	    bugtracker	=> {
#		web	=> 'https://rt.cpan.org/Public/Dist/Display.html?Name=App-Warning-Diagnostics',
#		# web	=> 'https://github.com/trwyant/perl-App-Warning-Diagnostics/issues',
		mailto  => 'wyant@cpan.org',
	    },
	    license	=> 'http://dev.perl.org/licenses/',
#	    repository	=> {
#		type	=> 'git',
#		url	=> 'git://github.com/trwyant/perl-App-Warning-Diagnostics.git',
#		web	=> 'https://github.com/trwyant/perl-App-Warning-Diagnostics',
#	    },
	},
	@extra,
    };
...
sub version_from {
    return 'lib/App/Warning/Diagnostics.pm';
}
...
My::Module::Meta - Information needed to build App::Warning::Diagnostics
...
This module centralizes information needed to build C<App::Warning::Diagnostics>. It
is private to the C<App::Warning::Diagnostics> package, and may be changed or
...
modules required to build the C<App::Warning::Diagnostics> package, suitable for
...
the modules required to run the C<App::Warning::Diagnostics>
